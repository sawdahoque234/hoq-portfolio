        ...
        <div className=" main d-flex align-items-center justify-content-center">
          <div className="home-body d-flex align-items-center justify-content-center">
            <div className="mt-5">
              ...
              <div className="intro">
                <h1 className="text-white">Sawda Hoque Tasfia</h1>
                <p>
                  I'm{" "}
                  <span style={{ fontWeight: "bold" }}>
                    {/* Style will be inherited from the parent element */}
                    <Typewriter
                      words={["a MERN Stack Developer | Front-end Developer "]}
                      cursor
                      cursorStyle="_"
                      typeSpeed={50}
                    />
              ...
              <div className="py-4">
                ...
                <a href="https://drive.google.com/file/d/1d63PoKN42K3j5kaQOKl9hs--dIiDfIJ5/view?usp=sharing">
                  <button
                    type="button"
